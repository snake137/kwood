...
class AddPostInTable extends Migration
{
    /**
     * Run the migrations.
     *
            ...
            ->insert([
                    ...
                    'text' => 'Давно выяснено, что при оценке дизайна и композиции читаемый текст мешает сосредоточиться.
                        Lorem Ipsum используют потому, что тот обеспечивает более или менее стандартное
                         ...
                         которое не получается при простой дубликации "Здесь ваш текст.. Здесь ваш текст..
                          Здесь ваш текст.." Многие программы электронной вёрстки и редакторы HTML используют
                ...
                [
                    ...
                    то есть более двух тысячелетий назад. Ричард МакКлинток, профессор латыни из колледжа Hampden-Sydney,
                         ...
                         Lorem Ipsum в разделах 1.10.32 и 1.10.33 книги "de Finibus Bonorum et Malorum"
                ...
                [
                    'name' => 'Где его взять?',
                    'text' => 'Есть много вариантов Lorem Ipsum, но большинство из них имеет не всегда приемлемые
    ...
    {
        DB::table('posts')
            ->where('name', '=', 'Что такое Lorem Ipsum?')
            ->orWhere('name', '=', 'Почему он используется?')
            ->orWhere('name', '=', 'Откуда он появился?')
            ->orWhere('name', '=', 'Где его взять?')
            ->delete();
    }
}
